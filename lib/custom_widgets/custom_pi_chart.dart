...
class ChartSegment {
  ...
  // Override == and hashCode for proper comparison of ChartSegment objects
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
          other is ChartSegment &&
...
class _CustomPieChartState extends State<CustomPieChart>
  ...
  ChartSegment? _currentlyLiftedSegment;
  ...
  ChartSegment? _hitTestSegment(Offset tapPosition, Size chartSize) {
            ...
            builder: (context, constraints) {
              ...
              return GestureDetector(
                onTapUp: (details) {
                  ...
                  final tappedSegment = _hitTestSegment(
                    localPosition,
                    chartSize,
                  );
...
class DonutChartPainter extends CustomPainter {
  ...
  final ChartSegment? liftedSegment;
  final bool? isValueOnChart;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final leftLabels = <(ChartSegment, Offset, double)>[];
    final rightLabels = <(ChartSegment, Offset, double)>[];
    ...
    for (var segment in segments) {
      ...
      paint.strokeWidth =
      (segment == liftedSegment) ? segmentWidth + 15 : segmentWidth;
      ...
      if (isValueOnChart == true) {
        ...
        final labelRadius = innerRadius + segmentWidth * .1;
    ...
    void drawFixedLabelBoxes(
        List<(ChartSegment, Offset, double)> entries,
        bool isRight,
        ) {
      ...
      for (int i = 0; i < entries.length && i < ySlots.length; i++) {
        ...
        final labelStyle = TextStyle(
          color: Colors.black.withAlpha((255 * animationValue).toInt()),
          fontSize: 14,
          fontFamily: 'Gilroy-semiBold',
          height: 1.4,
        );
        ...
        if (animationValue <= 0.5) {
          ...
          final animatedElbowPoint =
          Offset.lerp(pointOnArc, elbowPoint, progress)!;
          ...
          if (isValueOnChart == true) {
            ...
            final animatedTargetLabelConnectPoint =
            Offset.lerp(
              elbowPoint,
...
//       final midAngle =
//           startAngle + sweepAngle / 2; // Use globalStartAngle for this check
//       final isRightSide = midAngle < pi / 2 || midAngle > 3 * pi / 2;
//       // final isRightSide = midAngle < pi / 2 || midAngle > 3 * pi / 2;
...
//       final List<double> gradientStops;
//       if (isRightSide) {
//         // For segments on the right side (default behavior: darken at the end)
//         gradientColors = [segment.color, darken(segment.color, 0.25)];
//         gradientStops = const [0.95, 1.0];
//       } else {
//         // For segments on the left side (reverse behavior: darken at the beginning)
//         gradientColors = [
//           darken(segment.color, 0.25),
//           segment.color,
//         ]; // Darker color first
//         gradientStops = const [
//           0.0,
//           0.05,
//         ]; // Darken for the first 5% of the sweep
//       }
